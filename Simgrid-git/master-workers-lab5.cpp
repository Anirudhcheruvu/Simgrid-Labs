 ...
 //simgrid::s4u::this_actor::get_ppid()
  ...
  do {
    ...
    if (compute_cost > 0)
    {
      ...
      exec->set_tracing_category(my_host);
...
int main(int argc, char* argv[])
{
  ...
  xbt_assert(argc > 2, "Usage: %s platform_file deployment_file\n", argv[0]);
   ...
   simgrid::instr::declare_tracing_category("Tremblay", "1 0 0");  // red
  simgrid::instr::declare_tracing_category("Fafard", "0 1 0");  // green
   simgrid::instr::declare_tracing_category("Jupiter", "0 0 1");  // green
